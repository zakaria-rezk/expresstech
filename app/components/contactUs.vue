...
const contactCards = [
  {
    title: "تفضل بزيارتنا",
    lines: [
      "123 شارع التكنولوجيا، حي الابتكار، نيويورك 10001",
    ],
    Icon: MapPin,
  },
  {
  ...
  >
    <div class="mx-auto max-w-7xl px-5">
      ...
      <div class="text-center">
        <span
          class="inline-flex rounded-full bg-accent px-4 py-1.5 text-xs font-bold text-accent-foreground"
        >
          تواصل معنا
        </span>

        <h2
          class="mt-5 text-3xl font-extrabold tracking-tight text-brand-ink md:text-4xl"
        >
          تواصل معنا
        </h2>
      ...
      <!-- Content -->
      <div
        class="mt-12 grid gap-6 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)_minmax(0,1fr)]"
      >
        ...
        <div class="space-y-4">
          ...
          >
            <!-- Icon -->
            <span
              class="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-accent"
            >
              <component
                :is="card.Icon"
            ...
            <div>
              <p
                class="text-sm font-bold text-brand-ink"
              >
                {{ card.title }}
              </p>
        ...
        >
          <p
            class="text-base font-extrabold text-brand-ink"
          >
            أرسل لنا رسالة
          </p>
          ...
          >
            <label
              class="block text-xs font-semibold text-brand-ink"
            >
              الاسم بالكامل
          ...
          <!-- Subject -->
          <label
            class="mt-4 block text-xs font-semibold text-brand-ink"
          >
            الموضوع
        ...
        <!-- Map -->
        <div
          class="relative overflow-hidden rounded-2xl border border-border bg-card shadow-card"
        >
          <img
            :src="mapImg"
            alt="خريطة توضح موقع متجر إكسبرس هاي تك"
            width="1024"
            height="1024"
            loading="lazy"
          ...
          >
            <span
              class="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-primary"
            >
              <MapPin
            ...
            <div>
              <p
                class="text-xs font-bold text-brand-ink"
              >
                متجر إكسبرس هاي تك
              </p>
              ...
              >
                مفتوح الآن · يغلق الساعة 7 مساءً
              </p>
            </div>
          </div>
        </div>
